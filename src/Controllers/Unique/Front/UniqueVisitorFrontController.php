...
use DaydreamLab\Observer\Services\Unique\Front\UniqueVisitorFrontService;

class UniqueVisitorFrontController extends BaseController
{
    public function __construct(UniqueVisitorFrontService $service)
    {
