...
use DaydreamLab\Observer\Services\Unique\Admin\UniqueVisitorCounterAdminService;

class UniqueVisitorCounterAdminController extends BaseController
{
    public function __construct(UniqueVisitorCounterAdminService $service)
    {
