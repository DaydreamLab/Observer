...
use DaydreamLab\Observer\Requests\Unique\UniqueVisitorOrderingPost;
use DaydreamLab\Observer\Requests\Unique\UniqueVisitorRemovePost;
use DaydreamLab\Observer\Requests\Unique\UniqueVisitorStorePost;
use DaydreamLab\Observer\Requests\Unique\UniqueVisitorStatePost;
use DaydreamLab\Observer\Requests\Unique\UniqueVisitorSearchPost;

class UniqueVisitorController extends BaseController
{
    public function __construct(UniqueVisitorService $service)
    {
