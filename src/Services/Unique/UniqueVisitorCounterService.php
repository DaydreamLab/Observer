...
class UniqueVisitorCounterService extends BaseService
{
    protected $type = 'UniqueVisitorCounter';

    public function __construct(UniqueVisitorCounterRepository $repo)
    {
    ...
    {
        $result = $this->repo->updateCounter();
